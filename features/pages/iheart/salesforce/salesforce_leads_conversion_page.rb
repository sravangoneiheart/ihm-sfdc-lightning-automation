class SalesforceLeadsConversionPage < WebPage
  ...
  button(:convert_lead, :value => "Convert")
  ...
  checkbox(:no_opportunity,:id=>'nooppti')
...
text_field(:subject, :id => "tsk5_fu")
  ...
  def self.page_title_validation_value
    /Convert Lead|Salesforce - Unlimited Edition/
  end
  ...
  def self.page_url_validation_value
    /leadconvert|leadConvert|Convert Lead/i
  end
